...
bool cubicSpline::spline(BoundType type)
{
	...
	double* a=new double[sample_count_];
	double* b=new double[sample_count_];
	double* c=new double[sample_count_];
...
bool cubicSpline::getYbyX(double& x_in,double& y_out) const
{
	int klo,khi,k;
	klo=0;
	khi=sample_count_-1;
